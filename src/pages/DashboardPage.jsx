...
export const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-brand-pink selection:text-white w-full overflow-x-hidden">
      ...
      {/* Hero Section Offset Container (Accounts for Fixed Navbar) */}
      <div className="pt-[54px] sm:pt-[62px] md:pt-[66px] w-full transition-all duration-300">
